...
Files: macbook.glb [629.72KB] > D:\Projects\mackbook_gsap_app\mackbook_gsap_app\public\models\macbook-transformed.glb [627.9KB] (0%)
...
export default function MacbookModel(props) {
  ...
  /* useVideoTexuter a utilit funtion for to pass a video */
  const screen = useVideoTexture(texture);


  /* ye kuch settings ja jo apan mackbook14 16 se liye for color effect */
  useEffect(() => {
